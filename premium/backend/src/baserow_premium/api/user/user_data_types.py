...
class ActiveLicensesDataType(UserDataType):
    ...
    def get_user_data(self, user, request) -> dict:
        ...
        # PATCHED: Force Premium and Enterprise licenses as active
        # Get real workspace data if available, otherwise provide empty dict
        try:
            per_workspace_licenses = {
                workspace_id: {"premium": True, "enterprise": True}
        ...
        # Force instance-wide licenses to be active
